...
//   - lat/lng: NULLABLE (coordinates artık opsiyonel)
//   - rowToPublicView: coordinates null dönebilir
// =============================================================
import {
  mysqlTable,
  char,
...
export const properties = mysqlTable(
  "properties",
  {
    ...
    bedrooms: tinyint("bedrooms", { unsigned: true }),
    ...
    usage_status: varchar("usage_status", { length: 32 }),
    ...
    // has_map: coordinates yoksa 0 mantıklı; ama default’ı bozmayalım (controller override edecek)
