...
export type HomeRightColumnProps = {
...
export function HomeRightColumn(_props: HomeRightColumnProps) {
  return (
    <>
      <div className="text-center">
        ...
        <div className="bg-slate-50 border border-slate-200 p-4 md:p-6 rounded-lg mb-4 md:mb-6">
          <p className="text-sm md:text-base leading-relaxed text-gray-700">
            X Emlak ile satış/kiralama sürecinizi güvenle yönetin. Bölgesel emsal analizi, doğru fiyat aralığı,
            profesyonel ilan yönetimi ve hızlı iletişim desteğiyle; mülkünüzün değerini en doğru şekilde
            konumlandırmanıza yardımcı oluyoruz. İster satılık, ister kiralık; hedef kitleye doğru kanallardan
            ulaşmanız için süreç boyunca yanınızdayız.
          </p>
        </div>
        ...
        <div className="flex justify-center items-center space-x-4 md:space-x-8">
          <div className="text-center">
            <div className="w-20 h-20 md:w-28 md:h-28 bg-slate-900 rounded-full flex flex-col items-center justify-center text-white mx-auto shadow-lg ring-4 ring-slate-200">
              <svg className="w-6 h-6 md:w-8 md:h-8 mb-1" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
