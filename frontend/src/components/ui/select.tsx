...
function SelectContent({
  ...
  // ✅ Portal'ın gerçekten body'ye basıldığından emin ol
  ...
  return (
    <SelectPrimitive.Portal container={container ?? undefined}>
      <SelectPrimitive.Content
        ...
        position={position}
        // ✅ Stabil yerleşim (Radix)
        sideOffset={6}
        collisionPadding={10}
        // ✅ Kritik: opak arka plan + çok yüksek z-index
        className={cn(
          "z-[99999] overflow-hidden rounded-md border shadow-2xl",
          // Hard-opaque background: token'a güvenmiyoruz
      ...
      >
        ...
        <SelectPrimitive.Viewport
          // ✅ Bazı projelerde Content bg override edilse bile Viewport transparan kalabiliyor.
          // Bu yüzden Viewport'a da opak bg basıyoruz.
          className={cn(
            "p-1 bg-white dark:bg-slate-950",
            position === "popper" &&
